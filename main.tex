...
\nl Take  $S := \{1,2,\hdots,\epsilon^{-2}3n^2(2d)^{2n}\}$
 and randomly choose $A \in S^{n^2}$, and  $\alpha_{n-1}=(\alpha_1,\hdots,\alpha_{n-1}) \in S^{n-1}$\;
...
\nl Run \cite[Algorithm 2]{SH} $k \geq -\lg(1-(1+\epsilon)^{(-1/n)})$ times with input 
