...
results, we succeed with probability at least $1-(1/2)^k$. In ~\cite{SH} the algorithm is shown to succeed in a single run with  probability at least $1-21/32$. We bound the probability of success with $1-1/2$ for simplicity.
